...
import com.example.utils.SensitiveWordUtil;
...
public class MessageInfoController {
    ...
    public Result<MessageInfo> add(@RequestBody MessageInfoVo messageInfo) {
        String contetn =messageInfo.getContent();
        String result = sensitiveWordUtil.replace(contetn, '*');
        messageInfo.setContent(result);
