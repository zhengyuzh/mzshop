...
//        }
    ...
    public PageInfo<GoodsInfo> selectByGoodsIdList(List<Integer> recommendations) {
        List<GoodsInfo> list =  goodsInfoDao.getGoodsByIds(recommendations);
        return PageInfo.of(list);
    }

    public PageInfo<GoodsInfo> selectByGoodsRandom() {
        List<GoodsInfo> list =  goodsInfoDao.selectByGoodsRandom();
        return PageInfo.of(list);
    }
}
