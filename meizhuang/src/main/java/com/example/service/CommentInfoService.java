...
public class CommentInfoService {
    ...
    public List<RelateDTO> getAllGoodsComment() {
        List<RelateDTO> relateDTOList = commentInfoDao.getAllGoodsComment();
        return relateDTOList;

    }

    public Map<String, Object> selecCommentScoreBest(Long id) {
        Map<String, Object> result = commentInfoDao.getHighestScoreByUser(id);
        return result; // 只返回第一条数据
    }
